...
Copy-Item -LiteralPath (Join-Path $installerSource 'config\wizard-banner-ru.png') -Destination $configDirectory
Copy-Item -LiteralPath (Join-Path $installerSource 'config\wizard-banner-en.png') -Destination $configDirectory
Copy-Item -LiteralPath (Join-Path $installerSource 'config\wizard-banner-ru-source.png') -Destination $configDirectory
