...
int runSelfTests(const QString &outputDirectory){
    try{
        ...
        auto *commonPerspectiveSettings=window.findChild<QGroupBox*>("commonPerspectiveSettings");auto *vanishingPoint1Settings=window.findChild<QGroupBox*>("vanishingPoint1Settings");auto *gridColor=window.findChild<QPushButton*>("gridColor");
        require(commonPerspectiveSettings&&vanishingPoint1Settings&&gridColor&&commonPerspectiveSettings->isAncestorOf(rayStep)&&commonPerspectiveSettings->isAncestorOf(rayGap)&&commonPerspectiveSettings->isAncestorOf(rayStartOpacity)&&commonPerspectiveSettings->isAncestorOf(rayEndOpacity)&&commonPerspectiveSettings->isAncestorOf(rayFadeLength)&&vanishingPoint1Settings->isAncestorOf(gridColor),"perspective settings must separate common controls from point color");
